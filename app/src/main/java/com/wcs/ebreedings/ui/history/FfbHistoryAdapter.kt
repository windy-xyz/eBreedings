...
import com.wcs.ebreedings.ui.history.FfbHistoryAdapter.ViewHolder


class FfbHistoryAdapter(private val historyList: List<FfbYieldEntity>): RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.rowId = historyList[position].recording_id
        holder.rowDate.text = historyList[position].date_ffb_yield
        ...
        holder.rowHistoryLayout.setOnClickListener {
            ...
            val a = it.findFragment<FfbHistoryFragment>()
            a.findNavController().navigate(R.id.FfbYieldRecordingFragment, bundle)
        }
    }
